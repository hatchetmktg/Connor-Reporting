  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <p style="font-size: 12px;">Please use this form if your deposition is scheduled more than 48 hours in advance. If you have a deposition that needs to take place within the next 48 hours please call us at (800) 554-3376.</p>
